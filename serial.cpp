...
{    
    ...
    for( int step = 0; step < NSTEPS; step++ )
    {
        ...
        for (int i = 0; i < n; i++){
            ...
            bin[row * binNum + col].push_back(i);      //put the particle in to the bin
        }
                ...
                for (int j = row-1; j <= row+1; j++){
                    ...
                    if ((col != 0 && col != binNum)){
                        for (int k = col-1; k <= col+1; k++){
                            ...
                            for (int j1 = row-1; j1 <= row+1; j1++){
                                for (int k1 = col-1; k1 <= col+1; k1++){
